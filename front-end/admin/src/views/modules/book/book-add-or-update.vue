      ...
      <el-row>
        ...
        <el-col :span="6">
          <el-form-item label="出版日期">
            <el-date-picker type="month" value-format="yyyy-MM-dd" format="yyyy 年 M 月" placeholder="出版日期" v-model="book.publishDate"></el-date-picker>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        ...
        if (id) {
          this.$http({
            ...
            if (data && data.code === 200) {
              ...
              // 转换categoryId
              this.categoryOptionsSelect = this.book.categoryId.split(',').map((data) => {
                return +data
              })
            }
          })
